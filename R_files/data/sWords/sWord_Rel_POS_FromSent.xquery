...
return <sword> {$wr};{substring($wp, 1, 1)}*{$or};{substring($op, 1, 1)}*{$pr};{substring($pp, 1, 1)}*{$qr};{substring($qp, 1, 1)}*{$rr};{substring($rp, 1, 1)}*{$ar};{substring($ap, 1, 1)}*{$br};{substring($bp, 1, 1)}*{$cr};{substring($cp, 1, 1)}*{$dr};{substring($dp, 1, 1)}*{$er};{substring($ep, 1, 1)}*{$fr};{substring($fp, 1, 1)}*{substring($gr, 1, 1)};{$gp}#</sword> }

...
return <sword> {$wr};{substring($wp, 1, 1)};{$wl}*{$or};{substring($op, 1, 1)};{$ol}*{$pr};{substring($pp, 1, 1)};{$pl}*{$qr};{substring($qp, 1, 1)};{$ql}*{$rr};{substring($rp, 1, 1)};{$rl}*{$ar};{substring($ap, 1, 1)};{$al}*{$br};{substring($bp, 1, 1)};{$bl}*{$cr};{substring($cp, 1, 1)};{$cl}*{$dr};{substring($dp, 1, 1)};{$dl}*{$er};{substring($ep, 1, 1)};{$el}*{$fr};{substring($fp, 1, 1)};{$fl}*{$gr}{substring($gp, 1, 1)};{$gl};#</sword> }

                    ...
                    <xsl:choose>
                        <xsl:when test="./@relation != 'AuxX'">
                            <sWord><xsl:copy-of select="@*"/>
                                ...
                                <xsl:variable name="postag_1" select="substring(./@postag, 1, 1)"/>
                                <xsl:variable name="head_2" select="parent::sentence/word[@id = $head_1]/@head"/>
                                <xsl:variable name="postag_2" select="substring (parent::sentence/word[@id = $head_1]/@postag, 1,1)"/>
                                <xsl:variable name="head_3" select="parent::sentence/word[@id = $head_2]/@head"/>
                                <xsl:variable name="postag_3" select="substring (parent::sentence/word[@id = $head_2]/@postag, 1,1)"/>
